...
// CONCATENATED MODULE: ./packages/city-selector/src/city-selector.vue?vue&type=template&id=338d3ad4&
    ...
    recursiveOpt: function recursiveOpt(cityList) {
      ...
      if (this.multiple) {
        ...
        this.value.forEach(function (item) {
          ...
          _this.selectedOptions.push(_city);
        });
      } else {
